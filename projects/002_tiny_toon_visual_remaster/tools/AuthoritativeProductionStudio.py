...
class AuthoritativeProductionStudio(AuthoritativeRemasterStudio):
    ...
    def _build(self) -> None:
        ...
        ttk.Button(panel, text="CTRL+ALT+F8  FINALIZE RELEASE CANDIDATE", command=lambda: self.run_windows("Finalize_Release_Candidate.bat")).pack(side="left", padx=4)
    ...
    def _bind_shortcuts(self) -> None:
        ...
        self.bind("<Control-Alt-F8>", lambda event: self.run_windows("Finalize_Release_Candidate.bat"))
